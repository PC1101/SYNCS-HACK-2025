...
#load json 
with open("/Users/chenshihchi1/Downloads/weather data/rain_json_066006_2015_2025 2.json", "r") as f:
    data = json.load(f)
...
df.to_json("rainfall_clean.json", orient="records", date_format="iso")
