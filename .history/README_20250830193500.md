...
- Add in features that tracks beyond rainfall data ie. Electricity Use, Sewage Managment

Team:
Josh Morton: Data Visualisation
Jie Yong: RData Scraping 
Paul Chen: Risk Scoring Metric - Data Science & Modeling