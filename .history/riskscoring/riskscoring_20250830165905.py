...
#Step1: Create a drought label (weakly supervised)
...
# CSV format:
# station_name,population
# Sydney Olympic Park,5840
# Chatswood,25553
# ...
pop = pd.read_csv("suburb_population_2025.csv")
...
# Optional: log-scale for model stability
df["pop_2025_log1p"] = np.log1p(df["population_2025"])
...
# -------------------------
# Step 3: Train/test split
# Add population features to the model
features = ["rain_7d", "rain_30d", "rain_anomaly", "population_2025", "pop_2025_log1p"]
...
out.to_csv("rainfall_with_risk_and_population.csv", index=False)
print("Saved: rainfall_with_risk_and_population.csv")
